...
// jsc2210.10.js
//
// Cherednichenko JavaScript Collection Library (jsc) version 2210.10.
//
...
function jscLib() {
  ...
  /// </actual>
  /// <remarks>
  /// Номер версии определяется строкой в формате "ГГММ.ДД", где ГГ - две последние цифры года крайнего изменения данной
  /// версии библиотеки; а ММ - две цифры месяца крайнего изменения данной версии библиотеки, ДД - день изменения. Если
  /// это не оригинальная версия, то далее может быть добавлена дополнительная информация по усмотрению автора такой
  /// библиотеки в формате "ГГММ.ДД.N", где N - это и есть дополнительная информация.
  /// </remarks>
  this.version = function() {return '2210.10';}
  ...
  /// <example>
  /// <code>
  /// &lt;returns&gt;true, если указанную ссылку можно считать внешней.&lt;/returns&gt;
